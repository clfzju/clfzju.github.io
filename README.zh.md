...
**Try to understand code in `_include/` and `_layouts/`, then you can mod
y Jekyll [Liquid](https://github.com/Shopify/liquid/wiki) template directly to do more creative customization.**
